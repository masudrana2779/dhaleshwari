!function (e) {
    ...
    $(document).ready(function () {
            ...
            function bannerSliderOWLSlider()
            {
        ...
        $('.mainMenu ul a[href^="#"],.gotop a[href^="#"]').on('click', function (event) {
        ...
        function bannerSliderUsedSlickSlider() {
